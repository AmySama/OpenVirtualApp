...
public final class Form32x extends InsnFormat {
  ...
  public BitSet compatibleRegs(DalvInsn paramDalvInsn) {
    ...
    bitSet.set(0, unsignedFitsInShort(registerSpecList.get(0).getReg()));
  ...
  public boolean isCompatible(DalvInsn paramDalvInsn) {
    ...
    boolean bool1 = true;
    if (!bool || registerSpecList.size() != 2 || !unsignedFitsInShort(registerSpecList.get(0).getReg()) || !unsignedFitsInShort(registerSpecList.get(1).getReg()))
      bool1 = false; 
    return bool1;
  }
  ...
  public void writeTo(AnnotatedOutput paramAnnotatedOutput, DalvInsn paramDalvInsn) {
    RegisterSpecList registerSpecList = paramDalvInsn.getRegisters();
    write(paramAnnotatedOutput, opcodeUnit(paramDalvInsn, 0), (short)registerSpecList.get(0).getReg(), (short)registerSpecList.get(1).getReg());
  }
}


/* Location:              F:\何章易\项目文件夹\项目24\va\classes_merge.jar!\com\android\dx\dex\code\form\Form32x.class
