...
public final class Form21c extends InsnFormat {
  ...
  public boolean isCompatible(DalvInsn paramDalvInsn) {
    ...
    if (!unsignedFitsInShort(i))
      return false; 
    if (constant instanceof com.android.dx.rop.cst.CstType || constant instanceof com.android.dx.rop.cst.CstFieldRef || constant instanceof com.android.dx.rop.cst.CstString || constant instanceof com.android.dx.rop.cst.CstMethodHandle || constant instanceof com.android.dx.rop.cst.CstProtoRef)
      bool1 = true; 
    return bool1;
  }
...
/* Location:              F:\何章易\项目文件夹\项目24\va\classes_merge.jar!\com\android\dx\dex\code\form\Form21c.class
