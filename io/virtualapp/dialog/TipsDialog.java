...
public class TipsDialog extends Dialog {
  ...
  public TipsDialog(Context paramContext, String paramString1, String paramString2) {
  ...
  public TipsDialog(Context paramContext, String paramString1, String paramString2, String paramString3) {
    this(paramContext, 2131689644);
    this.mContext = paramContext;
    this.titleStr = paramString1;
    this.contentStr = paramString2;
  ...
  public TipsDialog(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4) {
    this(paramContext, 2131689644);
    this.mContext = paramContext;
    this.titleStr = paramString1;
    this.contentStr = paramString2;
...
/* Location:              F:\何章易\项目文件夹\项目24\va\classes_merge.jar!\io\virtualapp\dialog\TipsDialog.class
