...
public class SignInActivity extends VActivity implements View.OnClickListener, HttpCall {
  ...
  public void onSuccess(String paramString, JSONObject paramJSONObject) {
    ...
    if (httpBean.getStatus().equals("1")) {
      ...
      final TipsDialog dialog = new TipsDialog((Context)this, "提示", onPositionLisenter.getInfo(), "确定");
      tipsDialog.setOnPositionLisenter(new TipsDialog.OnPositionLisenter() {
            public void onPositionLisenter() {
              dialog.dismiss();
            }
  ...
  class TimeCount extends CountDownTimer {
    ...
    public void onTick(long param1Long) {
      ...
      TextView textView = SignInActivity.this.tvGetCode;
...
/* Location:              F:\何章易\项目文件夹\项目24\va\classes_merge.jar!\io\virtualapp\integralCenter\SignInActivity.class
