    ...
    public boolean onTransact(int param1Int1, Parcel param1Parcel1, Parcel param1Parcel2, int param1Int2) throws RemoteException {
      if (param1Int1 != 1598968902) {
        ...
        switch (param1Int1) {
          ...
          case 6:
            param1Parcel1.enforceInterface("android.content.pm.IPackageInstallerSession");
            removeSplit(param1Parcel1.readString());
            param1Parcel2.writeNoException();
            return true;
          case 5:
            param1Parcel1.enforceInterface("android.content.pm.IPackageInstallerSession");
    ...
    private static class Proxy implements IPackageInstallerSession {
      ...
      public boolean isMultiPackage() throws RemoteException {
        ...
        try {
          ...
          boolean bool = false;
          if (!iBinder.transact(10, parcel1, parcel2, 0) && IPackageInstallerSession.Stub.getDefaultImpl() != null) {
...
/* Location:              F:\何章易\项目文件夹\项目24\va\classes_merge.jar!\android\content\pm\IPackageInstallerSession.class
